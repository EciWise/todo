...
/** Mapper manual entidad -> DTO (sin MapStruct, patron de ECIWISE-STUDY). */
@Component
public class TaskMapper {
    ...
    public TaskResponse toResponse(Task task) {
        ...
        return new TaskResponse(
                ...
                task.getColor(),
                task.getDayOrder(),
                task.getRecurrenceFreq(),
                task.getRecurrenceInterval(),
                task.getRecurrenceEndType(),
                task.getRecurrenceEndDate(),
                task.getRecurrenceCount(),
                task.getCompletedAt(),
                subtasks,
                tags,
                task.getCreatedAt(),
